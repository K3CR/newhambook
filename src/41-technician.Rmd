...
SUBELEMENT T0 – SAFETY – [3 Exam Questions - 3 Groups] 
...
NOTE: The 3 graphics required for certain questions in sections T6C and T6D are included on the following pages.
